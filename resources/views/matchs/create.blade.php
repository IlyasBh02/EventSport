...
<div class="max-w-2xl mx-auto">
    <h2 class="text-3xl font-extrabold text-gray-900 mb-2">Planifier un match</h2>
    ...
    <div class="rounded-lg shadow-lg p-8">
        <form method="POST" action="{{ route('matchs.store', $event) }}">
            ...
            <div class="flex gap-3 mt-8 pt-6 border-t border-gray-100">
                ...
                <a href="{{ route('events.show', $event) }}" class="inline-flex justify-center py-2.5 px-5 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50">
                    Annuler
                </a>
            </div>
        </form>
