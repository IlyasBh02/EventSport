...
<div class="bg-white border border-slate-200 rounded-2xl p-5 mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-yellow-300 hover:shadow-sm transition-all">
